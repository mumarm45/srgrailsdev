    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="create" action="index"><g:message code="default.conversion.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="list-URLResource" class="content scaffold-list" role="main">
            ...
            <f:table collection="${URLResourceList}" />

            <div class="pagination">
                <g:paginate total="${URLResourceCount ?: 0}" />
            </div>
        </div>
    </body>
</html>